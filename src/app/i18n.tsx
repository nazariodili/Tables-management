...
const it: Dict = {
  ...
  zoomIn: "Ingrandisci", zoomOut: "Rimpicciolisci", resetZoom: "Reimposta zoom", setZoomTip: "Clicca per impostare lo zoom", fitScreen: "Adatta allo schermo",
  ...
  deleteTag: "Elimina tag", tagIcon: "Icona", tagNoIcon: "Nessuna icona", newTagName: "Nome nuovo tag", noTagsAdd: "Nessun tag. Aggiungine uno sotto.",
...
const fr: Dict = {
  ...
  zoomIn: "Zoom avant", zoomOut: "Zoom arrière", resetZoom: "Réinitialiser le zoom", setZoomTip: "Cliquer pour définir le zoom", fitScreen: "Ajuster à l'écran",
  ...
  deleteTag: "Supprimer le tag", tagIcon: "Icône", tagNoIcon: "Aucune icône", newTagName: "Nom du nouveau tag", noTagsAdd: "Aucun tag. Ajoutez-en un ci-dessous.",
...
const es: Dict = {
  ...
  zoomIn: "Acercar", zoomOut: "Alejar", resetZoom: "Restablecer zoom", setZoomTip: "Clic para ajustar el zoom", fitScreen: "Ajustar a pantalla",
  ...
  deleteTag: "Eliminar etiqueta", tagIcon: "Icono", tagNoIcon: "Sin icono", newTagName: "Nombre de etiqueta", noTagsAdd: "Sin etiquetas. Añade una abajo.",
...
const de: Dict = {
  ...
  zoomIn: "Vergrößern", zoomOut: "Verkleinern", resetZoom: "Zoom zurücksetzen", setZoomTip: "Klicken zum Zoom einstellen", fitScreen: "An Bildschirm anpassen",
  ...
  deleteTag: "Tag löschen", tagIcon: "Symbol", tagNoIcon: "Kein Symbol", newTagName: "Neuer Tag-Name", noTagsAdd: "Noch keine Tags. Unten einen hinzufügen.",
...
const pt: Dict = {
  ...
  zoomIn: "Aproximar", zoomOut: "Afastar", resetZoom: "Repor zoom", setZoomTip: "Clique para definir o zoom", fitScreen: "Ajustar ao ecrã",
  ...
  deleteTag: "Eliminar tag", tagIcon: "Ícone", tagNoIcon: "Sem ícone", newTagName: "Nome da nova tag", noTagsAdd: "Sem tags. Adicione uma abaixo.",
