...
const en: Dict = {
  ...
  obGuestsD: "Build your guest list; give people colors and tags.",
...
const it: Dict = {
  ...
  noMatches: "Nessun risultato", showGuests: "Mostra invitati {label}", filterBy: 'Filtra per "{name}"',
  ...
  totalSeats: "Totale: {n} posti ({a} + {b})", fewerSeats: "Meno posti", moreSeats: "Più posti", language: "Lingua",
  ...
  obGuestsT: "Aggiungi invitati", obGuestsD: "Crea la lista; assegna colori e tag alle persone.",
...
const fr: Dict = {
  ...
  noMatches: "Aucun résultat", showGuests: "Afficher les invités {label}", filterBy: 'Filtrer par "{name}"',
  ...
  totalSeats: "Total : {n} places ({a} + {b})", fewerSeats: "Moins de places", moreSeats: "Plus de places", language: "Langue",
  ...
  obGuestsT: "Ajouter des invités", obGuestsD: "Créez votre liste ; attribuez couleurs et tags.",
...
const es: Dict = {
  ...
  noMatches: "Sin resultados", showGuests: "Mostrar invitados {label}", filterBy: 'Filtrar por "{name}"',
  ...
  totalSeats: "Total: {n} asientos ({a} + {b})", fewerSeats: "Menos asientos", moreSeats: "Más asientos", language: "Idioma",
  ...
  obGuestsT: "Añadir invitados", obGuestsD: "Crea tu lista; asigna colores y etiquetas.",
...
const de: Dict = {
  ...
  noMatches: "Keine Treffer", showGuests: "{label} Gäste anzeigen", filterBy: 'Nach "{name}" filtern',
  ...
  totalSeats: "Gesamt: {n} Plätze ({a} + {b})", fewerSeats: "Weniger Plätze", moreSeats: "Mehr Plätze", language: "Sprache",
  welcomeTitle: "Willkommen bei Event Seating Planner 🎉", welcomeSub: "Plane, wer wo sitzt — ziehe Gäste in Sekunden an die Tische.",
  obGuestsT: "Gäste hinzufügen", obGuestsD: "Erstelle deine Liste; vergib Farben und Tags.",
...
const pt: Dict = {
  ...
  noMatches: "Sem resultados", showGuests: "Mostrar convidados {label}", filterBy: 'Filtrar por "{name}"',
  ...
  totalSeats: "Total: {n} lugares ({a} + {b})", fewerSeats: "Menos lugares", moreSeats: "Mais lugares", language: "Idioma",
  ...
  obGuestsT: "Adicionar convidados", obGuestsD: "Crie a sua lista; atribua cores e tags.",
